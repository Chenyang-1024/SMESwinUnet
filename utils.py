...
def test_single_volume(image, label, net, classes, patch_size=[256, 256], test_save_path=None, case=None, z_spacing=1,
    ...
    print("ACDC image shape ----> " + str(image.shape))
    if len(image.shape) == input_shape:
        ...
        for ind in range(image.shape[0]):
            ...
            with torch.no_grad():
                ...
                if out.sum() == 0:
                    print('out contains nothing!!!')
                else:
                    print('out contains somthing')
                # here is the issue locates in
                if x != patch_size[0] or y != patch_size[1]:
                ...
                if prediction.sum() == 0:
                    print('prediction contains nothing!!!')
                else:
                    print('prediction contains somthing')
    else:
